          ...
          <div className="space-y-3">
            ...
            {summary.hasCompetitorAds ? (
              <div className="flex items-start gap-2">
                ...
                <div>
                  <p className="text-sm text-white">{context.assets.competitorAds.length} competitor ad{context.assets.competitorAds.length > 1 ? 's' : ''}</p>
              ...
              <div className="flex items-start gap-2">
                ...
                <div>
                  <p className="text-sm text-gray-400">No competitor ad examples</p>
                </div>
              </div>
            )}
